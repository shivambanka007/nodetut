...
var userInfoSchema = new Schema(
  {
    ...
    mobile: {
      ...
      minLength: [8, 'Mobile number invalid'],
      maxLength: [14, 'Mobile number invalid'],
    },
    email: { type: String, required: [true, 'Email required'] },
    password: { type: String, required: true, maxLength: 256 },
    lastSeen: { type: Date, default: Date.now() },
    birthday: { type: Date, required: true },
    aboutMe: { type: String, maxLength: 256 },
    street: { type: String, maxLength: 256 },
    city: { type: String, maxLength: 256 },
    stateReside: { type: String, maxLength: 256 },
    zipcode: { type: String, minLength: 6, maxLength: 7 },
    img: {
      data: Buffer,
      contentType: String,
    },
